      ...
      <div className="mx-4 mb-6">
        ...
        <div className="bg-white rounded-lg p-4">
          ...
          <p className="text-center text-green-600 font-medium">
            "สุขภาพที่ดีไม่ได้เริ่มจากอาคาร หรือราคาแต่เริ่มเมื่อแพทย์เข้าใจ
            แต่เป็นสิ่งที่จับต้องได้"
          </p>

          <div className="mt-4">
            <p className="text-sm text-gray-600 mb-2">
              แพทย์...คนละใจกับนายทุนรักษา
            </p>
            <div className="flex items-start mb-2">
              ...
              <p className="text-sm">
                ดูแลสุขภาพแท้จริงไม่ ไม่บังคับ หายคุณภาพ ของคุณ
              </p>
            </div>
            <div className="flex items-start">
              ...
              <p className="text-sm">
                ยาราคาถูกลง เทียบเท่อง โดยรองรัฐ โบดรองรัฐ โดยรองรัฐ
                ระบะยาฟูกแล้ว แคะเวชภัณฑ์ สุขภาพฟรีของได้โดยคุณค่า
              </p>
            </div>
          </div>
